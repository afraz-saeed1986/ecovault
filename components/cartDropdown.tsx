  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      <div className="relative w-full max-w-sm sm:max-w-md bg-white h-full shadow-xl animate-slide-in-right flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-3 sm:space-y-4 overflow-x-hidden scrollbar-custom">
          {cart.length === 0 ? (
              ...
              >
                <Link href={`/product/${item.id}`} className="flex gap-2 sm:gap-3 w-full">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-eco-green font-semibold text-xs sm:text-sm">
                      ${item.price}
                    </p>
                  </div>
                </Link>
