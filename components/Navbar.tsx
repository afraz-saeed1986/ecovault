...
export default function Navbar() {
  ...
  // --- محاسبه دینامیک ارتفاع Navbar و اعمال آن به --navbar-height ---
  useEffect(() => {
    ...
    // هر بار که اندازه صفحه تغییر کنه یا منوی موبایل باز/بسته بشه
    window.addEventListener("resize", updateNavbarHeight);

    // MutationObserver برای تغییرات DOM داخل header (مثل باز شدن منو)
  ...
  }, [mobileMenuOpen]); // وابستگی به mobileMenuOpen برای واکنش سریع
  ...
  return (
    <>
      <header
        ref={headerRef}
        className="bg-eco-green dark:bg-eco-dark text-white dark:text-eco-light fixed top-0 left-0 right-0 z-40 shadow-md transition-colors duration-300"
      >
